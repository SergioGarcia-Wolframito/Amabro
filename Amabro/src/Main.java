...
public class Main implements Runnable{
		...
		try {
			...
			while(product_menu2 !=4) {
	    		...
	    		if(product_menu2 == 1) {
				   ...
				   for (int i = 0; i <= list1Product.size() - 1; i++) {
					   ...
					   System.out.println(i+1 + "Product :"); 
	  				   System.out.println("//Product Name:  " + list1Product.get(i).NameProduct 
	  				   + "//Product Price :"+list1Product.get(i).price
	  				   + "//Product Category: " 
	        	...
	        	if(product_menu2 == 2) {
	    			...
	    			System.out.println("To create a new product introduce Product Name, Product Price, Category Name,"
	    					+ " Sub Category Name and Category ID");
	    			System.out.println("");
	        	...
	        	if(product_menu2 == 3) {
	    				...
	    				list1Product.remove(delete_product-1);
		...
		try {
			...
			while(admin_menu_2 != 4) {
					...
					System.out.println("---------------------------------------------------------------");
					   ...
					   for (int i = 0; i <= list1Category.size() - 1; i++) {
						   ...
						   System.out.println(i+1 + "Category :"); 
		  				   System.out.println("//Name Category: " + list1Category.get(i).NameCategory 
		  						   + " //SubCategory: "
				...
				if(admin_menu_2 == 2) {
					...
					System.out.println("To create a new category introduce Category Name,"
							+ " Sub Category Name and Category ID");
					System.out.println("");
					System.out.println("Category name : ");
					name_category = fg.nextLine();
	...
	public synchronized void run() {
		...
		try {
			...
			f2.write((space)+(space)+(space)+(space)+" AMABRO BUY TICKET ");
			f2.write(jump);
			f2.write(jump);
	...
	private void user_products() {
		...
		try {
			...
			for (int i = 0; i <= list1Category.size() - 1; i++) {
				   ...
				   System.out.println(i+1 + "Category :"); 
				   System.out.println("//Name Category:  " + list1Category.get(i).NameCategory + " //SubCategory:  "
						   + list1Category.get(i).SubCategory + " //ID:  " 
						   + list1Category.get(i).IdCategory);
				...
				for (int i = 0; i <= list1Product.size() - 1; i++) {
						   ...
						   if(list1Product.get(i).compra) {
						    ...
						    System.out.println("Number of Products : "+list1Product.get(i).getCantidadcomprados());
						   	System.out.println("//Product Name:  " 
						    +list1Product.get(i).NameProduct + "//Product Price :"
						    +list1Product.get(i).price+"€");
						   	buy_controller = true;
								...
								if(list1Product.get(product_1).getCantidadcomprados() != 1) {
									...
									productcant = list1Product.get(product_1).getCantidadcomprados() - productcant;
										...
										if(producty>list1Product.get(product_1).getCantidadcomprados()) {
											...
											+ list1Product.get(product_1).getCantidadcomprados());
			...
			System.out.println("");
				...
				for (int i = 0; i <= list1Product.size() - 1; i++) {
					...
					if(list1Product.get(i).compra) {
						...
						System.out.println(i+1 + ".Product :"); 
					    System.out.println("Number of Products : " 
						+ list1Product.get(i).getCantidadcomprados());
					   	System.out.println("//Product Name:  " 
						+ list1Product.get(i).NameProduct 
					   	+ "//Product Price :"
						+list1Product.get(i).price+"€");
	...
	private void buymenu_5() {
		...
		try {
			...
			menu2dollar = hg.nextInt()-1;

			System.out.println("The price in dollars is : "
			+ Product.dolar(list1Product.get(menu2dollar).price) );
			System.out.println("");
